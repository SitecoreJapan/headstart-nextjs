...
const OcCheckout: FunctionComponent<{ onSubmitted: any }> = ({
  ...
  return (
    <div>
      {step === 0 && (
        <OcCheckoutShipping onPrev={handlePrevClick} onNext={handleNextClick} />
      )}
      {step === 1 && (
        <OcCheckoutBilling onPrev={handlePrevClick} onNext={handleNextClick} />
      )}
      {step === 2 && (
        <OcCheckoutPayment onPrev={handlePrevClick} onNext={handleNextClick} />
      )}
      {step === 3 && (
        <OcCheckoutReview
