...
export const ocProductsAdapter = createEntityAdapter<
...
export const getProduct = createOcAsyncThunk<
  RequiredDeep<BuyerProduct>,
  string
>("ocProducts/get", async (productId) => {
...
const ocProductCacheSlice = createSlice({
  ...
  reducers: {
    ...
    cacheProducts: (
      state,
      action: PayloadAction<RequiredDeep<BuyerProduct>[]>
    ) => {
